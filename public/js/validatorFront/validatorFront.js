...
fields=[
    ...
    }, //aca termina un campo y sigue el otro. no olvidar la coma si sigue otro. Se ponen la cantidad que quiera.
    {
        ...
        validations:[
            ...
            {val:(value)=>{return(value.length>=6)},msg:"La contraseña debe tener 6 o más caracteres."}
        ],
...
valForm("btnLogin",fields,classes); //Ejecuta la validación del formulario. Sólo se llena btnSubmit.
